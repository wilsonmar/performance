...
class Injector extends Simulation {
  ...
  setUp(
    ...
    details(postRequest.grpCampaign / "GetCompaign" ).responseTime.mean.lte( meanResponseTime),
    details(postRequest.grpCampaign / "GetCompaign" ).failedRequests.percent.lte( errorRate),
